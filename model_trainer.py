...
def train():
    ...
    exporter(model, feature_extraction)
    model_deleter()
    model_exporter()
...
def exporter(model, feature_extraction):
    # exporting models using pickle
    filename_model = './Models/trained_model.sav'
    filename_features = './Models/feature_extraction.sav'
